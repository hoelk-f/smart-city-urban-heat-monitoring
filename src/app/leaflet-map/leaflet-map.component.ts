...
export class LeafletMapComponent implements OnInit {
  ...
  private addLogoLegend() {
    ...
    logoLegend.onAdd = (map) => {
        ...
        div.innerHTML = `
            <img src="assets/images/smart-city-urban-heat-monitoring-logo.png" alt="Smart City Urban Heat Monitoring Logo" style="width:50px; height:auto; margin-bottom:8px; margin-right:10px;">
